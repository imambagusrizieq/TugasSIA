...
?>
 ...
 <a href="modul/pembayaran/aksi_pembayaran.php?act=delete&id=<?=
$row['id']; ?>" class="text-decoration-none">
 <i class="bi bi-trash text-danger"></i>
 </a>
 </td>
 <!-- Modal -->
 <div class="modal fade" id="editPembayaran<?= $row['id'] ?>" tabindex="-
1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 <form action="modul/pembayaran/aksi_pembayaran.php?act=update&id=<?=
$row['id'] ?>" method="post">
